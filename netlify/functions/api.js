...
function safeConfigDiagnostics(event) {
  ...
  add("Shopify credentials", hasConfig(), "For Shopify's 24-hour client-credentials token flow, add SHOPIFY_CLIENT_ID, SHOPIFY_CLIENT_SECRET and SHOPIFY_CLIENT_CREDENTIALS_ENABLED=true. Or add SHOPIFY_ADMIN_ACCESS_TOKEN if using a static custom-app token.");
