...
const API_ENDPOINTS = [
  ...
  { route: "auth-login", methods: ["POST"], access: ACCESS_TYPES.public },
  { route: "auth-logout", methods: ["POST"], access: ACCESS_TYPES.staff },
  { route: "auth-me", methods: ["GET"], access: ACCESS_TYPES.staff },
  { route: "admin-create-staff", methods: ["POST"], access: ACCESS_TYPES.admin },
  ...
  { route: "settings", methods: ["GET"], access: ACCESS_TYPES.staff },
  ...
  { pattern: /^replies\/[A-Za-z0-9_-]+\/resolve$/, methods: ["POST"], access: ACCESS_TYPES.staff },
  { route: "history", methods: ["GET"], access: ACCESS_TYPES.staff },
  ...
  { pattern: /^templates\/[A-Za-z0-9_-]+$/, methods: ["PUT", "DELETE"], access: ACCESS_TYPES.admin },
  ...
  { route: "shopify-search-orders", methods: ["GET"], access: ACCESS_TYPES.staff },
  { route: "shopify-search-products", methods: ["GET"], access: ACCESS_TYPES.staff },
  { route: "twilio-send-substitution", methods: ["POST"], access: ACCESS_TYPES.staff },
  { route: "twilio-send-custom", methods: ["POST"], access: ACCESS_TYPES.staff },
